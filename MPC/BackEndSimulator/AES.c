...
void MixColumn(bit src[])
{
    ...
    for(c=0;c<4;c++)
    {
        for(i=0;i<4;i++)
        {
            a02s[i][4]=XOR(src[c*8+i*32+7],src[c*8+i*32+3]);
            a02s[i][3]=XOR(src[c*8+i*32+7],src[c*8+i*32+2]);
            a02s[i][1]=XOR(src[c*8+i*32+7],src[c*8+i*32+0]);
        }
        ...
        i=1;
        {
            dst[c*8+i]=XOR(a02s[0][i],a02s[1][i]);
            dst[c*8+i]=XOR(dst[c*8+i],src[c*8+i+64]);
            dst[c*8+i]=XOR(dst[c*8+i],src[c*8+i+96]);
            
            dst[c*8+i+32]=XOR(a02s[2][i],a02s[1][i]);
            dst[c*8+i+32]=XOR(dst[c*8+i+32],src[c*8+i]);
            dst[c*8+i+32]=XOR(dst[c*8+i+32],src[c*8+i+96]);
            
            dst[c*8+i+64]=XOR(a02s[2][i],a02s[3][i]);
            dst[c*8+i+64]=XOR(dst[c*8+i+64],src[c*8+i]);
            dst[c*8+i+64]=XOR(dst[c*8+i+64],src[c*8+i+16]);
            
            dst[c*8+i+96]=XOR(a02s[3][i],a02s[0][i]);
            dst[c*8+i+96]=XOR(dst[c*8+i+96],src[c*8+i+32]);
            dst[c*8+i+96]=XOR(dst[c*8+i+96],src[c*8+i+64]);
        }
        for(i=3;i<=4;i++)
...
void AddRoundKey(bit ROUNDKEY[],bit MSG[],int round)
{
    int i;
    for(i=0;i<128;i++)
        MSG[i]=XOR(MSG[i],ROUNDKEY[128*round+i]);
}
void SubBytes(bit MSG[])
{
    int i=0;
    for(i=0;i<16;i++)
        GFINV(&(MSG[i*8]));
