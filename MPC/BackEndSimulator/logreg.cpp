...
__pool__float* sgd(int size, __pool__float* X, __pool__float* y, __pool__float alpha, int n) {
...
void logreg() {
    ...
    float X1_data[data_size] = {2.7810836, 1.465489372, 3.396561688,
    ...
    __pool__float* W = sgd(data_size, X1, y, alpha, iterations);
    return;
    float w0, w1, w2;
